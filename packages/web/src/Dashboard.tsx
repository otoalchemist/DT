...
` +
                      `Autonomous: it arms payments itself when a citizen falls behind, paying on the "Payment Coinbase Bid" and dropping back to the "Audit Coinbase Bid" on quiet epochs. Both are set under Coinbase bid — while this is on, they are spent without a keypress.` +
                      `
