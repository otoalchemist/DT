...
export interface TargetScoreRow {
  ...
  /**
   * @deprecated Always false. Kept so rows cached by an older backend still parse. The
   * curated do-not-target roster it fed has been retired — every live rival is a target now.
   */
  uncatchable: boolean;
  score: number;
}
